export default function Agradecimentos() {
  return (
    <div className={`
        ...
        font-pt-mono
      `} id="agradecimentos">
      <p className={`text-center sm:text-3xl xl:text-5xl animate-skew-stop tracking-wider font-caveat`}>Agradecimentos</p>
      <p className={`text-center lg:pt-8 lg:text-xl tracking-widest py-1`}>
      ...
      <p className={`text-center lg:text-xl tracking-widest py-1`}>
      ...
      <p className={`text-center xl:text-8xl tracking-widest lg:pt-4 font-allura  animate-wiggle`}>
        Aloha!
      </p>
    </div>
  )
