    ...
    <div className={`
      ...
      <div className="w-full grid grid-cols-2 justify-center items-center pt-8">
        ...
        <div className="lg:w-11/12 flex flex-col">
          <span className="text-sm lg:text-2xl lg:py-2">1º Lugar: Troféu, Bloco e Tatuagem no valor de R$500,00.</span>
          <span className="text-sm lg:text-2xl lg:py-2">2º Lugar: Medalha e Kits.</span>
          <span className="text-sm lg:text-2xl lg:py-2">3º Lugar: Medalha e Kits.</span>
          <span className="text-sm lg:text-2xl lg:py-2">4º Lugar: Medalha e Kits.</span>
        </div>
      </div>
    </div>
  )
