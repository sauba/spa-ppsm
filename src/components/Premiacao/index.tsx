...
export default function Premiacao() {
  return (
    <div className={`
      ...
      <p className={`text-center text-sm xl:text-xl tracking-wider pt-4`}>
        Enviar comprovante para o Whatsapp (81)985259168 <a href="https://wa.me/5581985259168" referrerPolicy="no-referrer" target="_blank" className={`py-2 mx-auto flex justify-center items-center rounded-3xl font-caveat`}>
